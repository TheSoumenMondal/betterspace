...
export function DiaTextReveal({
	...
	// biome-ignore lint/correctness/useExhaustiveDependencies: texts is derived from text and isMulti is derived from texts length. Array join stabilizes inline arrays.
	useEffect(() => {
